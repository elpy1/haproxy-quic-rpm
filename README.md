...
| --- | --- | --- |
| haproxy-quic | el9 | [AWS-LC](https://github.com/aws/aws-lc) 1.72.1 |
...
```bash
make rpm-build HAPROXY_VERSION=3.2.16 AWS_LC_VERSION=1.72.1
```
...
```bash
make rpm-build HAPROXY_VERSION=3.2.16 AWS_LC_VERSION=1.72.1 PACKAGE_RELEASE=2
```
...
RPMS
└── x86_64
    └── haproxy-quic-3.2.16-2.aws_lc.1.72.1.el9.x86_64.rpm
SRPMS
└── haproxy-quic-3.2.16-2.aws_lc.1.72.1.el9.src.rpm
```
...
Tags should use the form `v<HAPROXY_VERSION>-aws-lc-<AWS_LC_VERSION>`, for example `v3.2.16-aws-lc-1.72.1`.
...
```
dnf install /path/to/haproxy-quic-3.2.16-2.aws_lc.1.72.1.el9.x86_64.rpm
```
...
```
$ haproxy -v
HAProxy version 3.2.16 2026/04/23 - https://haproxy.org/
Status: long-term supported branch - will stop receiving fixes around Q2 2030.
Known bugs: http://www.haproxy.org/bugs/bugs-3.2.16.html
Running on: Linux 5.14.0-611.47.1.el9_7.x86_64 #1 SMP PREEMPT_DYNAMIC Wed Apr 8 12:18:23 UTC 2026 x86_64
```
